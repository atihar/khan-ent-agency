...
<div class="site-header header-bottom-area">
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container"><a class="navbar-brand" href="/"><img class="site-logo" src="assets/images/logo/logo.png" alt="Logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="nav-modules list-unstyled d-md-flex align-items-center mx-3 mx-lg-0">
                    ...
                    <li><a class="btn btn-outline-black-header text-black" href="/contact">Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>
