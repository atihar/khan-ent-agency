            ...
            <div class="row gx-lg-5">
                <div class="col-lg-3">
                    <div class="footer-widget footer-widget-1">
                        <h5 class="mb-3 text-theme-color">Holding no. 0071, Flat Road, Maijdee Court, Noakhali, 3800, BD</h5>
                        ...
                        <ul class="list-unstyled list-inline mt-5 mb-5 mb-md-0">
                            ...
                            <li class="list-inline-item border border-white py-2 px-3"><a class="text-white" href="#"><i class="fab fa-twitter"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3">
            ...
            <div class="row gx-lg-5 align-items-center">
                <div class="col-md-6">
                    <div class="footer-widget">
                        <p class="m-md-0">© 2021 Designed by Weabers</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="footer-widget">
