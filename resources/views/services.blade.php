...
<article class="entry">
    <div class="entry-content">
        ...
        <!-- testimonials-->
        <div class="bg-half">
            <div class="container mb-lg-6 mb-md-5 mb-4">
                <div class="row gx-lg-0">
                    <div class="col-12 d-lg-none"><img src="assets/images/10.jpg" alt="project"></div>
                    <div class="col-lg-6 service-1 order-lg-1"></div>
                    <div class="col-lg-6">
                        <div class="bg-black">
        ...
        <div class="container mb-lg-6 mb-md-5 mb-4">
            <div class="row gx-lg-0">
                <div class="col-12 d-lg-none"><img src="assets/images/12.jpg" alt="project"></div>
                <div class="col-lg-6 service-3 order-lg-1"></div>
                <div class="col-lg-6">
                    <div class="bg-black">
                        <div class="py-lg-7 px-lg-6 py-md-6 px-md-5 py-5 px-4">
                            <div class="text-white pr-lg-4">
        ...
        <div class="container mb-lg-9 mb-md-7 mb-6">
            <div class="row gx-lg-0">
